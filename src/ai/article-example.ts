export const exampleArticle = {
  ...
  sections: [
    ...
    {
      heading: "Making It Work Everywhere",
      paragraphs: [
        `That gap between who’s connected and who’s not remains wide and persistent. While cities are moving fast, rural areas are often left to catch up on their own. <a href="#" class="text-blue-600 underline hover:text-blue-800">38% of people in Africa are online</a>, compared to a global average of 68%. That difference doesn’t just slow down internet speeds; it limits what people can do. Without a connection, there’s no easy way to apply for jobs, join an online class, or even send money.`,
        ...
        `Regional collaboration helps turn these tools into shared systems. <a href="#" class="text-blue-600 underline hover:text-blue-800">African Continental Free Trade Area (AfCFTA)</a> is a start. This is about digital policies that work across borders. E-commerce and mobile payment platforms need consistency to function across countries. If Ghana and Nigeria can agree on a framework, others may follow. Cross-border cooperation like this could speed up tech adoption, spark regional startups, and build digital networks that don’t stop at national lines.`,
        ...
        `Digital infrastructure is isn’t just about speed or scale. It’s about who gets to benefit and how those benefits ripple outward. If only <a href="#" class="text-blue-600 underline hover:text-blue-800">28.5% of sub-Saharan Africans</a> have internet access while the global average sits at 67%, then the work ahead is clear. We either build systems that serve everyone or risk deepening the divide.`,
